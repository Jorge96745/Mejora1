...
class TriviaGame(BoxLayout):
    def __init__(self, **kwargs):
        ...
        self.options_layout = BoxLayout(orientation="vertical", size_hint=(1, 0.5))
        self.add_widget(self.options_layout)

        self.score_label = Label(text=f"Puntaje: {self.score}", font_size=20, size_hint=(1, 0.1))
    ...
    def load_question(self):
        ...
        for option in question_data["options"]:
            btn = Button(text=option, font_size=18, size_hint_y=None, height=50)
